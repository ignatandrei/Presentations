...
folder='../2024/';
file='PackageAnalyzer'
fileHtml='presentation/PackageAnalyzer.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2024/';
file='Playwright'
fileHtml='presentation/Playwright.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2024/';
file='Battle'
fileHtml='presentation/Battle.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2025/';
file='Net9WhatsNew'
fileHtml='presentation/Net9WhatsNew.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2025/';
file='GenAIScript'
fileHtml='presentation/GenAIScript.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2025/';
file='MCPTools';
fileHtml='presentation/MCPTools.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2026/';
file='PlaywrightMCPAgents';
fileHtml='presentation/PlaywrightMCPAgents.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
...
folder='../2026/';
file='GitHubCopilot';
fileHtml='presentation/GitHubCopilot.html';  
archive = new DirArchiver(`${folder}${file}`, `../docs/${file}.zip`,[]);
fs.copyFileSync(`${folder}${file}/${fileHtml}`, `../docs/${file}prez.html`);
