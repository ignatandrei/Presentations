...
namespace OtherConsumer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (var connection = factory.CreateConnection())
            {
                using (var channel = connection.CreateModel())
                {
                    ...
                    consumer.Received += OtherConsumer_Received;


                    channel.BasicConsume(queue: "BackSendQueue",
                                         autoAck: true,
                                         consumer: consumer);
        ...
        private static void OtherConsumer_Received(object sender, BasicDeliverEventArgs ea)
        {
            ...
            using (var span = tracer.StartActiveSpanFromActivity(act.OperationName, act, SpanKind.Client, out tsMultiple))
            {
                ...
                OtherConsumerJob(message);
            }
        }

        private static void OtherConsumerJob(string message)
        {
